...
/////////////////////////////NAV选项卡////////////////////////////////////////////
    ...
    let info=[
        {name:'内地',tell:'111111111',py:'neidi'},
        {name:'港台',tell:'222222222',py:'gangtai'},
        {name:'欧美',tell:'333333333',py:'oumei'},
        {name:'日本',tell:'444444444',py:'riben'},
        {name:'其他',tell:'555555555',py:'qita'},
    ]
    rander(info);
    let dts=document.querySelectorAll('.scroll>li');
    console.log(dts)
    let arr=[];
    let heights=document.querySelector('#search').offsetHeight+tip.offsetHeight;
    ...
    search.onkeyup=function(){
        ...
        let data=info.filter(function(element){
            return element.name.includes(value)||element.py.includes(value)||element.tell.includes(value);
        })
        rander(data);
    }
